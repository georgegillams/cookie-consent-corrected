...
class Button extends Component {
  ...
  render = () => {
    ...
    const classNameFinal = ['button__outer'];
    if (destructive) {
      classNameFinal.push('button__outer--destructive');
    }
    if (bouncy) {
      if (!light) {
        classNameFinal.push('button__outer--dark-text');
      }
      classNameFinal.push('button__outer--bouncy');
      if (destructive) {
        classNameFinal.push('button__outer--bouncy--destructive');
      }
      if (disabled) {
        classNameFinal.push('button__outer--disabled');
      }
    } else {
      classNameFinal.push('button__outer--no-bouncy');
      if (destructive) {
        classNameFinal.push('button__outer--no-bouncy--destructive');
      }
      if (disabled) {
        classNameFinal.push('button__outer--disabled');
      }
    ...
    if (large) {
      classNameFinal.push('button__outer--large');
    }
